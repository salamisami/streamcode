...
def get_process_by_name(process_name):
    ...
    for process_id in processes:
        ...
        try:
            h_process = win32api.OpenProcess(win32con.PROCESS_QUERY_INFORMATION | win32con.PROCESS_ALL_ACCESS, True, process_id)
...
def print_id():
    ...
    id_pointer = process.get_pointer(base_address + 0x050112F0, offsets=[0xAE8, 0xF0, 0x128, 0x58, 0xD0, 0x1D0, 0x208, 0x30, 0x3C8])
